...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/Strawberry/output/train/exp_893aug_887_m/weights/best_ap05.pt',
                        help='weights path')  # from yolov5/models/
    parser.add_argument('--img-size', nargs='+', type=int, default=[448, 448], help='image size')  # height, width
    ...
    try:
        ...
        torch.onnx.export(model, img, f, verbose=True, opset_version=12, input_names=['images'], export_params=True,
