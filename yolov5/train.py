...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='../dataset/yolov5m.pt', help='initial weights path')
    ...
    parser.add_argument('--project', default='output/train', help='save to project/name')
